...
| 6.4.0                          | 6.4.0  | http://dl.bintray.com/radugalik/elastic-morphology/analysis-morphology-6.4.0.zip |
...
where @URL@ is the URL of the plugin from the compatibility table. For examples to install version @6.4.0@ run

<pre>
bin/elasticsearch-plugin install http://dl.bintray.com/radugalik/elastic-morphology/analysis-morphology-6.4.0.zip
</pre>
